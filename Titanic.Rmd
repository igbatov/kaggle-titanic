...
In this section we will use glm to make predictions and will not think about interpritability of the model. Let's try to make glm with all avaliable predictors.
```{r}
